        ...
        const graph = [
            {
                ...
                count: data.stats[0].base_stat
            },
            {
                stat: data.stats[1].stat.name,
                count: data.stats[1].base_stat
            },
            {
                stat: data.stats[2].stat.name,
                count: data.stats[2].base_stat
            },
            {
                stat: data.stats[3].stat.name,
                count: data.stats[3].base_stat
            },
            {
                stat: data.stats[4].stat.name,
                count: data.stats[4].base_stat
            },
            {
                stat: data.stats[5].stat.name,
                count: data.stats[5].base_stat
            }
        ];
        new (0, _autoDefault.default)(document.getElementById("stat"), {
            type: "bar",
            data: {
